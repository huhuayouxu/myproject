...
import com.example.speextest.R.string;
...
public class AudioRecordButton extends Button implements AudioStageListener {
	...
	public void setCompression(int com){
		this.mAudioManager.compression = com;
		Log.v("qqq", "button set compre " + com);
	}
	public void setTimeLen(int timelen){
		this.mAudioManager.timelen = timelen;
	}
	...
	public AudioRecordButton(Context context, AttributeSet attrs) {
	    ...
	    if (Environment.MEDIA_MOUNTED.equals(state)) 
	        dir = Environment.getExternalStorageDirectory()
				  + "/com.example.speextest";
	    else
	    	dir = Environment.getDataDirectory() + "/com.example.speextest";
