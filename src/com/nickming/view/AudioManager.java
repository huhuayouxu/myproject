...
import com.example.speextest.SpeexRecorder;
...
public class AudioManager {
	...
	public SpeexRecorder spxRecorder;
	private String mDirString;
	public int compression = 0;
	public int timelen = 50;
	...
	public void prepareAudio() {
		try {
			...
			spxRecorder = new SpeexRecorder(file.getAbsolutePath(), compression, timelen);
            Thread spxRecTh = new Thread(spxRecorder);
            spxRecTh.start();
