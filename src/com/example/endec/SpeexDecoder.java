...
public class SpeexDecoder {
	protected com.example.endec.Speex speexDecoder;
	...
	public void decode() throws Exception {
		...
		try {
			...
			while (true) {
				...
				header[24] = 0;
				header[25] = 0;
				chksum = com.example.writer.OggCrc.checksum(0, header, 0, OGG_HEADERSIZE);
				...
				chksum = com.example.writer.OggCrc.checksum(chksum, header, OGG_HEADERSIZE, segments);
				...
				for (curseg = 0; curseg < segments; curseg++) {
					...
					chksum = com.example.writer.OggCrc.checksum(chksum, payload, 0, bodybytes);
