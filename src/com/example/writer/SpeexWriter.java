...
//	private Logger log = LoggerFactory.getLogger(SpeexWriter.class);
	...
	private com.example.writer.SpeexWriteClient client = new com.example.writer.SpeexWriteClient();
