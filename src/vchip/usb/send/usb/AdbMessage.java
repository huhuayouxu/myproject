...
public class AdbMessage {
    ...
    public AdbMessage() {
        mMessageBuffer = ByteBuffer.allocate(64);
    ...
    public void set(byte[] paramArrayOfByte, int paramInt ){
    	if(paramInt == CMD_LENGTH){
    		if(paramArrayOfByte !=null){
    			 this.mMessageBuffer.put(paramArrayOfByte, 0, paramArrayOfByte.length);
    			 return;
    		}else{
    			 byte[] arrayOfByte2 = new byte[64];
    		      System.arraycopy(paramArrayOfByte, 0, arrayOfByte2, 0, CMD_LENGTH);
    		      return;
    		}
    	}else if (paramInt != 0){
    		  byte[] arrayOfByte2 = new byte[64];
    		  arrayOfByte2[0] =(byte) 0x5A;
    		  arrayOfByte2[1] =(byte) 0x5A;
    		  arrayOfByte2[2] =(byte) 0xA5;
    		  arrayOfByte2[3] =(byte) 0xA5;
    		  arrayOfByte2[4] =(byte) 0x3B;
    		  arrayOfByte2[5] =(byte) paramInt;
    		  System.arraycopy(paramArrayOfByte, 0, arrayOfByte2, 6, paramArrayOfByte.length);
    		  
    		  this.mMessageBuffer.put(arrayOfByte2, 0, CMD_LENGTH);
    		  Log.i("ls", "setSendData: "+getCmdString());
    		  return;
    	}else{
    		byte[] arrayOfByte1 = new byte[64];
    	    couter = 1 + couter;
    	    arrayOfByte1[0] =(byte) 0x5A;
    	    arrayOfByte1[1] =(byte) 0x5A;
    	    arrayOfByte1[2] =(byte) 0xA5;
    	    arrayOfByte1[3] =(byte) 0xA5;
    	    arrayOfByte1[4] =(byte) 0x3B;
//    	    arrayOfByte1[5] = (byte)(0xFF & couter >> 8);
    	    arrayOfByte1[5] = (byte) 0x00;
    	    arrayOfByte1[6] = (byte)(0xFF & couter);
    	    ...
    	    for (int i = 15; ; ++i)
    	    {
    	      if (i >= 64)
    	      {
    	        ...
    	        arrayOfByte1[7] = (byte)(int)(l & 0xFF);
    	        arrayOfByte1[8] = (byte)(int)(0xFF & l >> 8);
    	        arrayOfByte1[9] = (byte)(int)(0xFF & l >> 16);
    	        arrayOfByte1[10] = (byte)(int)(0xFF & l >> 24);
    	        arrayOfByte1[11] = (byte)(int)(0xFF & l >> 32);
    	        arrayOfByte1[12] = (byte)(int)(0xFF & l >> 40);
    	        arrayOfByte1[13] = (byte)(int)(0xFF & l >> 48);
    	        arrayOfByte1[14] = (byte)(int)(0xFF & l >> 56);
    	        this.mMessageBuffer.put(arrayOfByte1, 0, 64);
    	        return;
    	      }
    ...
    public void set(byte[] paramArrayOfByte, int paramInt ,int total ,int current){
    	if(paramInt == CMD_LENGTH){
    		if(paramArrayOfByte !=null){
    			 this.mMessageBuffer.put(paramArrayOfByte, 0, paramArrayOfByte.length);
    			 return;
    		  ...
    		  arrayOfByte2[4] =(byte) 0x3B;
    		  arrayOfByte2[5] =(byte) paramInt;
    		  arrayOfByte2[6] =(byte) total;
    		  arrayOfByte2[7] =(byte) current;
    		  System.arraycopy(paramArrayOfByte, 0, arrayOfByte2, 8, paramArrayOfByte.length);
...
//    	    arrayOfByte1[5] = (byte)(0xFF & couter >> 8);
    ...
    public int getDataLength() {
        return mMessageBuffer.getInt(5);
    }
    ...
    public String getCmdString()
    {
      ...
      for (int i = 0; i < CMD_LENGTH ; ++i)
      {
        ...
        arrayOfObject[0] = Byte.valueOf(this.mMessageBuffer.get(i));
    ...
    public boolean write(AdbDevice device) {
        synchronized (device) {
            ...
            Log.i("AdbMessage", "send data : "+getCmdString());
            if (request.queue(mMessageBuffer, 64)) {
                int length = getDataLength();
//                if (length > 0) {
...
//                }
    ...
    public boolean readCommand(UsbRequest request) {
        request.setClientData(this);
        return request.queue(mMessageBuffer, CMD_LENGTH);
    }
